...
public:
  ...
  static std::string attribString(const Attribute& attrib);  //convert attribute pair to string
  static Attribute attribute(const Name& name, const Value& value); // construct a attribute
