#pragma once
/////////////////////////////////////////////////////////////////////
// Convert.h - Convert between XML and Element<Data>              //
//                                                                 //
...
* Package Operations:
* -------------------
* support Persist package for serialization and restoration of data
* convert xml to custom elment type.
* convert elment type to xml string
*	----------------------------
*  Maintenance History:
* --------------------
*  ver 1.0 : 07 Feb 2017
